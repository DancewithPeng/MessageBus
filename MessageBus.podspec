#
#  Be sure to run `pod spec lint MessageBus.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.source_files  = "MessageBus/Sources", "MessageBus/Sources/**/*.{h,m}"
  # spec.exclude_files = "Classes/Exclude"

  spec.public_header_files = "MessageBus/Sources/MBMessageBus.h"
